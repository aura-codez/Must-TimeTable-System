    ...
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            ...
            <?php if (!empty($selected_timetable)): ?>
                ...
                <?php 
                // Dynamically fetch sessions, sections, and time slots from the timetable data
                $sessions = array_unique(array_column($selected_timetable, 'session'));
                sort($sessions);
                $sections = array_unique(array_column($selected_timetable, 'section'));
                sort($sections);
                $days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'];
                $time_slots = array_unique(array_column($selected_timetable, 'time_slot'));
                sort($time_slots);
