...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_profile'])) {
    ...
    if ($userModel->updateProfile($user_id, $name, $email, $contact, $password)) {
        // Redirect to clear POST data and prevent loop
        echo "<script>alert('✅ Profile updated successfully!'); window.location.href='/MUST-Timetable-System/views/admin/profile.php';</script>";
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            <h2 class="text-warning text-center mb-4">👤 Admin Profile</h2>
