...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand text-warning fw-bold" href="/MUST-Timetable-System/views/superadmin/dashboard.php">🛠️ Superadmin Panel</a>
        ...
        <div class="collapse navbar-collapse justify-content-end pe-3" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-light" href="/MUST-Timetable-System/views/superadmin/dashboard.php">🏠 Dashboard</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="/MUST-Timetable-System/views/superadmin/profile.php">👤 Profile</a></li>
